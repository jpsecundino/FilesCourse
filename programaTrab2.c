...
For the sake of clarity, many of the functions used in this project are declared in a second and third files, named "fileManagement.h" and "ioProgTrabalho2.h".
